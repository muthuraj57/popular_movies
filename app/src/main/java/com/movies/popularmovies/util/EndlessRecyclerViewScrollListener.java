...
/**
 * Created by muthu-3955 on 15/10/16.
 */
...
//        Log.i(mTag, "onScrolled-------dy:" + dy);
        ...
        boolean shouldLoadMore = (lastVisibleItemPosition + visibleThreshold) > totalItemCount;
...
//        Log.i(mTag, "isFooterView:" + isFooterView);
    ...
    //set startingPageIndex   default: 1
